...
4. PCR products were purified and size selected using the Agencourt AMPure XP bead system (Beckman Coulter, USA) with a bead concentratioin of 1.2X (for 18S amplicons). 
